...
class AnimatedListD2Animation extends StatefulWidget {
  const AnimatedListD2Animation({super.key});
  static String routeName = '/misc/animated_list';

  @override
  State<AnimatedListD2Animation> createState() => _AnimatedListD2AnimationState();
}

class _AnimatedListD2AnimationState extends State<AnimatedListD2Animation> {
  ...
  void addUser() {
    setState(() {
      ...
      listData.add(
        UserModel(++_maxIdValue, 'New: $_maxIdValue', 'Person: $_maxIdValue'),
      );
