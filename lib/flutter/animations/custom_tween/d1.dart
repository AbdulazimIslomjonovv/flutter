...
class CustomTweenD1Animation extends StatefulWidget {
  const CustomTweenD1Animation({super.key});
  static const String routeName = '/basics/custom_tweens';

  @override
  State<CustomTweenD1Animation> createState() => _CustomTweenD1AnimationState();
}

class _CustomTweenD1AnimationState extends State<CustomTweenD1Animation>
